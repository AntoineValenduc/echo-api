...
class __TwigTemplate_4744666f7053437cc5b6e4b99f6f695c extends Template
{
...
(isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 9, $this->source); })())]), "profiler_markup_version" => 3]);
    ...
    ";
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 422
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 422, $this->source); })()));
            yield "))) {
                            var stackElement = {
                                error: false,
                                url: url,
        ...
        // line 832
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new RuntimeError('Variable "token" does not exist.', 832, $this->source); })()), "html", null, true);
        yield "\x27);
    /*]]>*/</script>
</div>
...
";
    ...
    {
        return array (  928 => 832,  896 => 803,  662 => 572,  539 => 451,  507 => 422,  501 => 419,  497 => 418,  491 => 415,  487 => 414,  440 => 370,  375 => 308,  369 => 304,  367 => 303,  75 => 19,  64 => 14,  59 => 11,  57 => 9,  56 => 4,  52 => 3,  48 => 1,);
    }
...
<!-- END of Symfony Web Debug Toolbar -->
", "@WebProfiler/Profiler/toolbar_js.html.twig", "/home/antoine/projects/echo/echo-api/symfony/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar_js.html.twig");
    }
}
